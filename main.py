...
def resize_and_insert_image(background_image_path, insert_image_path, output_image_path, new_size, insert_position, blend_mode):
    ...
    background_image.paste(blended_image, insert_position)
...
insert_image_path = 'insert.png'  # Path to the image to be inserted (with alpha channel)
output_image_path = 'output.jpg'  # Path to save the resulting image
...
resize_and_insert_image(background_image_path, insert_image_path, output_image_path, new_size, insert_position, blend_mode)
